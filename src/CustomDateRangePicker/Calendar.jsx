...
class Calendar extends PureComponent {
  ...
  changeShownDate = (value, mode = "set") => {
    ...
    const modeMapper = {
      yearOffset: () => addYears(focusedDate, value),
  ...
  renderMonthAndYear = (focusedDate, changeShownDate, props) => {
    let { showMonthArrow } = props;
    const styles = this.styles;
    const monthStep = addMonths(this.state.focusedDate, 0);
    let todaySelected = isSameMonth(monthStep, new Date());
    return (
